...
for model in data:
    ...
    empty = unicode("")
    filteredModel = model.objects.filter((Q(prijs__exists=True) & Q(naam__exists=True) & Q(stock__exists=True) & Q(link__exists=True) & Q(herkomst__exists=True) & (categorie__exists=True)))
