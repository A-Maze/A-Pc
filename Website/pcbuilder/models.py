...
class Behuizingen(Document):
    ...
    Behuizing_bay_extern = StringField(max_length=50)
    Socket = StringField(max_length=200)
    CPU_SoC = StringField(max_length=200)
    Geheugentype_moederbord = StringField(max_length=200)
    Form_Factor = StringField(max_length=200)
    Inclusief_voeding=StringField(max_length=200)
    Voeding_form_factor = StringField(max_length=50)
    Voeding_plaats = StringField(max_length=50)
    Materialen_Staal = StringField(max_length=50)
    ...
    Audio_uitgangen = StringField(max_length=200)
    Video_uit = StringField(max_length=200)
    Fan_poorten = StringField(max_length=50)
    CPU_koeler_maximum_hoogte = StringField(max_length=50)
    Grafische_kaart_maximum_lengte = StringField(max_length=50)
    Behuizing_Panel = StringField(max_length=50)
    ...
    Gewicht = StringField(max_length=50)
    Meegeleverde_fans = StringField(max_length=50)
    Behuizingtype = StringField(max_length=50)
    Fabrieksgarantie = StringField(max_length=50)
    Kabelmanagement = StringField(max_length=50)
    Bijzonderheden = StringField(max_length=200)
...
class Geheugen(Document):
    ...
    categorie = StringField(max_length=120)
    naam = StringField(max_length=500)
    subnaam = StringField(max_length=200)
