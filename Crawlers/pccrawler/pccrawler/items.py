...
class GPU(scrapy.Item):
    ...
    Hoogste_HDMI-versie = scrapy.Field()
    Hoogste_DisplayPort-versie = scrapy.Field()
...
class Moederbord(scrapy.Item):
    ...
    Dual_of_Single_BIOS/UEFI = scrapy.Field()
...
class Behuizing(scrapy.Item):
    ...
    Form Factor = scrapy.Field()
    Behuizing Panel = scrapy.Field()
    Materialen  Staal = scrapy.Field()
    Grafische kaart maximum lengte = scrapy.Field()
    CPU koeler maximum hoogte = scrapy.Field()
    Kleuren = scrapy.Field()
    Behuizing bay intern = scrapy.Field()
    Behuizing bay extern = scrapy.Field()
    Aansluitingen voorzijde = scrapy.Field()
    Inclusief voeding = scrapy.Field()
    Voeding plaats = scrapy.Field()
    Voeding form factor = scrapy.Field()
    Fan-poorten = scrapy.Field()
    Meegeleverde fans = scrapy.Field()
